...
import 'package:cashkit/screens/profile/Goals/create_goals/view.dart';
                    ...
                    children: [
                      Padding(
                        ...
                        child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("  You have 3 ongoing saving goals",
                                  style: TextStyle(
                                      fontSize: 17,
                                      color: Color(0xff292929),
                                      fontWeight: FontWeight.w600)),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                height: 70,
                                width:
                                    MediaQuery.of(context).size.width.w * 0.65,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(" ${containerData[index].goalName}",
                                        style: TextStyle(
                                            fontSize: 15,
                                    ...
                                    LoadingProg(
                                        totalAmount:
                                            containerData[index].totalAmount,
                                        spentAmount:
                                            containerData[index].spendAmount),
                                  ],
                                ),
                              )
                            ],
